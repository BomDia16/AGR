    ...
    <body class="antialiased">
        ...
        <div class="grey lighten-2 login container">
            ...
            <div class="row">
                ...
                @endif
                <form method="POST" action="{{ route('admin.update', $admins->id) }}" class="col s12">
                    @csrf
                    @method('put')
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="name" name="name" type="text" class="validate" value="{{ $admins->name }}">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="email" name="email" type="text" class="validate" value="{{ $admins->email }}">
                    ...
                    <!-- Password -->
                    <input type="hidden" name="password" value="{{ $admins->password }}">

                    <div class="row">
                        <div class="col s2"></div>
                        <div class="col s7">
                            <button class="btn waves-effect waves-light blue darken-4" type="submit" name="action">Salvar</button>
                        </div>
                        <div class="col s2"></div>
                    </div>
                </form>
