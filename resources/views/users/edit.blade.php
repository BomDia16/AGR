    ...
    <body class="antialiased">
        ...
        <div class="grey lighten-2 login container">
            ...
            <div class="row">
                ...
                @endif
                <form method="POST" action="{{ route('user.update', $users->id) }}" class="col s12">
                    @csrf
                    @method('put')
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="name" name="name" type="text" class="validate" value="{{ $users->name }}">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="email" name="email" type="text" class="validate" value="{{ $users->email }}">
